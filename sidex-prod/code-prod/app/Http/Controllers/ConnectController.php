...
class ConnectController extends Controller
{
    ...
    public function postRegister(Request $request){
        ...
        if($validator->fails()):
            ...
            if($user->save()):
                return redirect('/login')->with('message', 'Su usuario se creo con éxito, ahora puede iniciar sesión')
    ...
    public function postRecover(Request $request){
        ...
        if($validator->fails()):
            ...
            if($user == "1"):
                ...
                return back()->withErrors($validator)->with('message', 'Este correo electrónico no existe.')
            ->with('typealert', 'danger');
            endif;
        endif;
    }
    ...
    public function postReset(Request $request){
        ...
        if($validator->fails()):
            ...
            if($user == "1"):
                ...
                return back()->withErrors($validator)->with('message', 'El correo electrónico o el código de recuperación son erróneos .')->with('typealert', 'danger');
            endif;
        endif;
    }
}

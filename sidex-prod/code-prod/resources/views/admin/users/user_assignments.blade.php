                    ...
                    <div class="panel shadow">
                        ...
                        <div class="inside">
                            @if(kvfj(Auth::user()->permissions, 'service_add'))
                                {!! Form::open(['url' => '/admin/user/'.$u->id.'/assignments/units']) !!} 
            ...
            @if(kvfj(Auth::user()->permissions, 'user_assignments_services'))
                <div class="col-md-5">
                    <div class="panel shadow">
                        ...
                        <div class="header">
                            <h2 class="title"><i class="fas fa-plus-circle"></i> Asignar Servicio</h2>
                        </div>

                        <div class="inside">
                            @if(kvfj(Auth::user()->permissions, 'service_add'))
                                {!! Form::open(['url' => '/admin/user/'.$u->id.'/assignments/services']) !!}

             ...
             <table class="table table-striped table-hover mtop16">
                <thead>
                    <tr>
                        ...
                        <td width="480px">DESCARGAR LISTADO</td>
                    </tr>
                </thead>
                <tbody>
                    @foreach($units as $u)
                        <tr>
                            ...
                            <td>
                                <div class="opts">
                                    <a href="{{ url('/unit/'.$u->id.'/services/todos') }}"><i class="fas fa-eye"> Ver</i> </a>
                                </div>
                            </td>
                            <td>
                                <div class="opts">
                                    <a href="{{ url('/unit/'.$u->id.'/imprimir-listado') }}"><i class="fas fa-file-pdf"></i> Descargar</i> </a>
                                </div>
                            </td>
                        </tr>
                    @endforeach                    
